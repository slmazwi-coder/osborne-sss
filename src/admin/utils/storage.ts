...
const SCHOOL_DATA_VERSION = 'osborn-sss-v1';
...
const defaultContact: ContactInfo = {
  address: 'Tshungwana A/A, Osborn, Mount Frere, 5090 (Eastern Cape)',
  phone: '083 210 5055 / (039) 254 8224',
...
const defaultAbout: AboutInfo = {
  historyParagraphs: [
    'Osborn Senior Secondary School is a public senior secondary school located at Dundee A/A, Mount Ayliff, in the Alfred Nzo West Education District of the Eastern Cape.',
    'Operating as a No-Fee school, Osborn SSS is committed to academic excellence, community values, and nurturing the potential of every learner. Our motto — "Let There Be Light" — inspires us to reach for greatness.',
  ...
  principalName: 'Mr N Siyangaphi',
  principalTitle: 'Principal',
  principalMessage: [
    'Welcome to Osborn Senior Secondary School. Our institution stands as a beacon of academic excellence and community spirit in the heart of Mount Ayliff.',
    'At Osborn SSS, we believe that every learner has the potential to reach for the sky. Our dedicated team of 54 teachers works tirelessly to nurture talent, foster creativity, and build responsible citizens.',
    'Together, we create an environment where "We are unity" is not just a phrase, but a way of life. Our learners leave Osborn SSS not only with knowledge but with values that will serve them throughout their lives.',
  ],
};
