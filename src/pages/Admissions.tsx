...
const inp =
  'border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#C9A84C]/40 focus:border-[#1B4D2E] transition w-full bg-white';
...
const SectionHeading = ({ icon, title }: { icon: React.ReactNode; title: string }) => (
  <div className="flex items-center gap-2 pb-2 border-b border-gray-200 mb-4">
    <span className="text-[#1B4D2E]">{icon}</span>
      ...
      <div className="py-20 flex items-center justify-center min-h-[60vh]">
        ...
        >
          ...
          <p className="text-gray-600 mb-8">
            Thank you for applying to Osborn Senior Secondary School. We have received your application and will be in contact shortly.
          </p>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
              <div>
                ...
                <p className="text-white/70 text-sm mt-1">
                  Osborn Senior Secondary School &nbsp;·&nbsp; Igoga Location, Matatiele 4730
                </p>
              </div>
                  ...
                  <>
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="text-sm font-semibold text-[#1B4D2E] underline underline-offset-2"
                      >
                          ...
                          return (
                            <div
                              ...
                              className={`relative flex items-center gap-3 p-3 rounded-xl border-2 transition
                                ${file
                                  ? 'border-[#1B4D2E] bg-[#FDF9EC]'
                                  : field.required
                                    ? 'border-dashed border-red-300 bg-red-50/40'
                                    : 'border-dashed border-gray-300 bg-gray-50'}`}
                            >
                              <div className={`shrink-0 w-8 h-8 rounded-lg flex items-center justify-center ${file ? 'bg-[#C9A84C] text-white' : 'bg-gray-200 text-gray-400'}`}>
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                {file && <div className="text-xs text-[#1B4D2E] truncate mt-0.5">{file.name}</div>}
