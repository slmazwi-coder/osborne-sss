...
export const About = () => {
  ...
  const campusImageUrl = '/assets/about/FB_IMG_1780366637639.jpg';
  ...
  return (
    <div className="py-12 sm:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Page Title */}
        <h1 className="section-title">About Osborn SSS</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-stretch mb-16 sm:mb-24">
          ...
          >
            <div className="border-l-4 border-[#1B4D2E] pl-5 mb-6">
              <h2 className="text-2xl font-bold text-[#1B4D2E]">Our School</h2>
            </div>
            <div className="space-y-4 text-gray-600 leading-relaxed text-base">
              <p>
                Osborn Senior Secondary School (Osborn SSS) is a public senior secondary school 
                located at Tshungwana A/A, Mount Frere, Eastern Cape. The school serves the 
                Umzimvubu Local Municipality within the Alfred Nzo West Education District 
                and operates as a No-Fee school.
              </p>
              <p>
                Under the inspiring motto "Let There Be Light", Osborn SSS has built a proud 
                community of learners and a strong culture of unity and academic ambition.
              </p>
              <p>
                With approximately 1,743 learners and 54 committed teachers, 
          ...
          <motion.div
            ...
            viewport={ { once: true } }
            className="bg-[#FDF9EC] rounded-3xl overflow-hidden shadow-lg border border-[#1B4D2E]"
          >
            <div className="bg-[#1B4D2E] p-6 sm:p-8">
              {/* Outer holder: rounded + gold frame all around */}
              <div
                className="w-full rounded-3xl bg-[#1B4D2E] p-2 sm:p-3"
                ...
                <div className="w-full rounded-2xl overflow-hidden shadow-xl" style={ { aspectRatio: '4/3' } }>
                  {!campusFailed ? (
                    <img
                      src={campusImageUrl}
                      alt="School campus"
                      className="w-full h-full object-contain bg-[#1B4D2E]"
                      onError={() => setCampusFailed(true)}
                    />
                  ) : (
                    <div className="w-full h-full bg-gradient-to-br from-[#1B4D2E] via-[#C9A84C] to-[#1B4D2E] flex items-center justify-center">
        ...
        >
          ...
          <div className="text-center mb-10">
            <h2 className="text-3xl font-extrabold text-[#1B4D2E] mb-2">Principal's Message</h2>
            <div className="w-16 h-1 bg-[#1B4D2E] mx-auto rounded-full" />
          </div>

          {/* Card */}
          <div className="bg-[#FDF9EC] rounded-3xl overflow-hidden shadow-lg border border-[#1B4D2E]">
            <div className="grid grid-cols-1 md:grid-cols-3">

              {/* Principal Photo Column */}
              <div className="flex flex-col items-center justify-center bg-[#1B4D2E] p-8 md:p-10">
                {/* Photo frame */}
                <div className="w-40 h-40 md:w-48 md:h-48 rounded-full overflow-hidden border-4 border-[#C9A84C] shadow-xl mb-5">
                  {!principalFailed ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-[#1B4D2E]">
                ...
                {/* Decorative divider */}
                <div className="w-10 h-0.5 bg-[#1B4D2E] mt-4 rounded-full opacity-60" />
              </div>

              {/* Message Column */}
              <div className="col-span-2 flex flex-col justify-center p-8 md:p-12">
                {/* Opening quote mark — decorative only, not wrapping text */}
                <div className="text-[#1B4D2E] text-6xl font-serif leading-none mb-2 opacity-40 select-none">
                  "
                </div>

                <div className="space-y-4 text-gray-700 text-base sm:text-lg leading-relaxed">
                  <p>
                    Welcome to Osborn Senior Secondary School. Our institution stands as a 
                    beacon of academic excellence and community spirit in the heart of 
                    Mount Ayliff.
                  </p>
                  <p>
                    At Osborn SSS, we believe that every learner has the potential to reach 
                  ...
                  <p>
                    Together, we create an environment where "Let there be light" is not just 
                    a phrase, but a way of life. Our learners leave Osborn SSS not only with 
                    knowledge but with values that will serve them throughout their lives.
                  </p>
                </div>

                {/* Closing quote mark — decorative only */}
                <div className="text-[#1B4D2E] text-6xl font-serif leading-none mt-2 text-right opacity-40 select-none">
                  "
                </div>
              </div>
